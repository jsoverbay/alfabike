...
# 'c:\python27\python.exe py2exesetup.py py2exe' in a console prompt.
#
...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "platbike45.py"
 
        #Name of program
        self.project_name = "Alfabike"
 
        #Project url
        self.project_url = "http://www.energyresearchlabs.com/alfabike/"
        ...
        #Auhor of program
        self.author_name = "Jeremy Overbay"
        self.author_email = "jsoverbay@gmail.com"
        self.copyright = "Copyright (c) 2013 Jeremy Overbay."
 
        #Description
        self.project_description = "Alfabike"
